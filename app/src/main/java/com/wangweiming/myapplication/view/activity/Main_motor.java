 ...
 * 电动车出租
 */
public class Main_motor extends AppCompatActivity {
    List<Motorsbean> motorList ;
    QuickAdapter quickAdapter;
    BmobQuery<Motorsbean> local ;
    RecyclerView rv;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.main_motor);
        init();
        initdata();
        initAdapter();
        initClickListener();
    ...
    private void initAdapter() {
        quickAdapter=new QuickAdapter<Motorsbean>(motorList) {
            @Override
            ...
            @Override
            public void convert(VH holder, Motorsbean motorsbean, int position) {
                holder.setText(R.id.title,motorsbean.getName());
                holder.setImage(R.id.img,motorsbean.getPrice());
            }
        };
    }
    ...
    private void init() {
        ...
        local = new BmobQuery<Motorsbean>();
    ...
    private void initdata() {
        ...
        local.findObjects(new FindListener<Motorsbean>() {
            ...
            public void done(List<Motorsbean> object, BmobException e) {
                ...
                {
                    motorList = object;
                    quickAdapter.refresh(motorList);
